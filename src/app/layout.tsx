...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://res.cloudinary.com/dc3o4l7rx/image/upload/q_auto/f_auto/v1776439268/Black_and_Gray_Minimalist_Creative_Portfolio_Presentation_fuafoo.png",
        width: 1200,
        height: 630,
        alt: "Shubham Nakashe Portfolio Preview",
      },
    ],
  },
  twitter: {
    ...
    images: ["https://res.cloudinary.com/dc3o4l7rx/image/upload/q_auto/f_auto/v1776439268/Black_and_Gray_Minimalist_Creative_Portfolio_Presentation_fuafoo.png"],
  },
  robots: {
    index: true,
    follow: true,
